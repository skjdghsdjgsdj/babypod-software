...
class APIRequest:
	...
	def get_verb(self) -> str:
		"""
		What verb this HTTP request is, like "GET"
	...
	def get_connection_method(self) -> Callable[..., adafruit_requests.Response]:
		...
		This is an abstract method and the base implementation raises NotImplementedError().
...
class APIRequestFailedException(Exception):
	...
	def __init__(self, request: APIRequest, http_status_code: int = 0):
		"""
		Creates an APIRequestFailedException.
...
class GetAPIRequest(APIRequest):
	...
	def get_connection_method(self) -> Callable[..., adafruit_requests.Response]:
		"""
		Returns an instance of adafruit_requests.Session.get.
		:return: an instance of adafruit_requests.Session.get
		"""
...
class PostAPIRequest(APIRequest):
	...
	def get_connection_method(self) -> Callable[..., adafruit_requests.Response]:
		"""
		Returns an instance of adafruit_requests.Session.post.
		:return: an instance of adafruit_requests.Session.post
		"""
...
class DeleteAPIRequest(APIRequest):
	...
	def get_connection_method(self) -> Callable[..., adafruit_requests.Response]:
		"""
		Returns an instance of adafruit_requests.Session.delete.
		:return: an instance of adafruit_requests.Session.delete
		"""
